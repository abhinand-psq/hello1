     ...
     <section className="bg-blue-500 text-white py-20">
        <div className="container mx-auto px-6 text-center md:text-left md:flex md:items-center md:space-x-12">
          <div className="md:w-1/2">
            ...
            <Link href="#features" className="bg-white text-blue-500 py-3 px-8 rounded-lg font-semibold shadow-md hover:bg-gray-100">Learn More</Link>
          </div>
          <div className="md:w-1/2 mt-10 md:mt-0">
            <Image src="https://via.placeholder.com/500" alt="MyApp preview" className="rounded-lg shadow-lg" />
          </div>
        </div>
      </section>
    </div>
